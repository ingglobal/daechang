...
var items = [
  {w: 2, h: 1, noResize: true, content: '<div class="widget_title"><span>UPH</span></div><div class="widget_content"><iframe id="frame_02" src="<?=G5_MONITOR_URL?>/dashboard/uph.php?w=2&h=1" frameborder="0" scrolling="no"></iframe></div>'},
  {w: 2, h: 1, noResize: true, content: '<div class="widget_title"><span>목표대비 생산량</span></div><div class="widget_content"><iframe id="frame_02" src="<?=G5_MONITOR_URL?>/dashboard/production_today.php?w=2&h=1" frameborder="0" scrolling="no"></iframe></div>'},
  {w: 2, h: 1, noResize: true, content: '<div class="widget_title"><span>47호기</span></div><div class="widget_content"><iframe id="frame_02" src="<?=G5_MONITOR_URL?>/dashboard/mms.php?w=2&h=1&mms_idx=138" frameborder="0" scrolling="no"></iframe></div>'},
  {w: 6, h: 2, noResize: true, content: '<div class="widget_title"><span>한달 생산 그래프</span></div><div class="widget_content frame_03"><iframe id="frame_03" src="<?=G5_MONITOR_URL?>/dashboard/production_weekly.php?w=5&h=2" frameborder="0" scrolling="no"></iframe></div>'},
  {w: 2, h: 1, noResize: true, content: '<div class="widget_title"><span>48호기</span></div><div class="widget_content"><iframe id="frame_02" src="<?=G5_MONITOR_URL?>/dashboard/mms.php?w=2&h=1&mms_idx=139" frameborder="0" scrolling="no"></iframe></div>'},
  {w: 2, h: 1, noResize: true, content: '<div class="widget_title"><span>49호기</span></div><div class="widget_content"><iframe id="frame_02" src="<?=G5_MONITOR_URL?>/dashboard/mms.php?w=2&h=1&mms_idx=141" frameborder="0" scrolling="no"></iframe></div>'},
  {w: 2, h: 1, noResize: true, content: '<div class="widget_title"><span>50호기</span></div><div class="widget_content"><iframe id="frame_02" src="<?=G5_MONITOR_URL?>/dashboard/mms.php?w=2&h=1&mms_idx=140" frameborder="0" scrolling="no"></iframe></div>'},
  {w: 2, h: 1, noResize: true, content: '<div class="widget_title"><span>51호기</span></div><div class="widget_content"><iframe id="frame_02" src="<?=G5_MONITOR_URL?>/dashboard/mms.php?w=2&h=1&mms_idx=143" frameborder="0" scrolling="no"></iframe></div>'},
  {w: 2, h: 1, noResize: true, content: '<div class="widget_title"><span>52호기</span></div><div class="widget_content"><iframe id="frame_02" src="<?=G5_MONITOR_URL?>/dashboard/mms.php?w=2&h=1&mms_idx=144" frameborder="0" scrolling="no"></iframe></div>'}
];
var options = {
    column:6,
    handle:'.widget_title',
