...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>" tr_id="<?php echo $row['shp_idx'] ?>">
        ...
        <td class="td_shp_sort">
            <input type="text" name="shp_sort[<?=$i?>]" value="<?=number_format($row['shp_sort'])?>" onclick="javascript:numtoprice(this)" class="frm_input shp_sort wg_wdx60 wg_right">
        </td>
...
$(function(e) {
    ...
    $("#ser_st_date, #ser_en_date").datepicker({ changeMonth: true, changeYear: true, dateFormat: "yy-mm-dd", showButtonPanel: true, yearRange: "c-99:c+99" });
