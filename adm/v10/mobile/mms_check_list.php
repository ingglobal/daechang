...
$g5['title'] = '품질검사 필요한 설비지정';
$g5['box_title'] = '제품의 품질 확인을 해야 하는 설비를 선택하세요.';
...
<div id="mobile_cont_box">
    ...
    <ul id="lst">
        ...
        <li class="<?=($row['mms_item_check_yn']?'focus':'')?>">
...
$('.mms_chk').on('click', function(){
    ...
    // flag = flag ? 0 : 1;
    // console.log(flag);
    mms_check_update(mms_idx,flag);
});

function mms_check_update(mms_idx,flag){
    var ajx_url = '<?=G5_USER_ADMIN_MOBILE_AJAX_URL?>/mms_item_check_update.php';
