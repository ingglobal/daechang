...
$g5['title'] = '설비 수동카운트 현황';
$g5['box_title'] = '설비의 수동카운트 설정/해제';
...
<div id="mobile_cont_box">
    ...
    <ul id="lst">
        ...
        <li class="<?=($row['mms_manual_yn']?'focus':'')?>">
...
$('.mms_chk').on('click', function(){
    ...
    // flag = flag ? 0 : 1;
    // console.log(flag);
    mms_manual_count_update(mms_idx,flag);
});

function mms_manual_count_update(mms_idx,flag){
    var ajx_url = '<?=G5_USER_ADMIN_MOBILE_AJAX_URL?>/mms_manual_count_update.php';
