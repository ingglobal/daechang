...
1,31 = 일별인 경우 1일단위 31개=1달이 그래프 초기 범위가 됩니다.'); ?>
		...
		<tr>
			...
			<td colspan="3">
				...
				<input type="text" name="set_ppr_data_type" value="<?php echo $g5['setting']['set_ppr_data_type']; ?>" class="frm_input" style="width:90%;">
			</td>
		</tr>
		<tr>
		...
		<tr>
            <th scope="row">생관자재메뉴권한</th>
            <td>
                <?php echo help('생관자재관리자의 메뉴 접근권한입니다.') ?>
                <textarea name="set_admin_material_auth" id="set_admin_material_auth" style="width:50%;"><?php echo get_text($g5['setting']['set_admin_material_auth']); ?></textarea>
            </td>
        </tr>
		<tr>
            <th scope="row">생기공무메뉴권한</th>
            <td>
                <?php echo help('생기공무관리자의 메뉴 접근권한입니다.') ?>
                <textarea name="set_admin_tech_auth" id="set_admin_tech_auth" style="width:50%;"><?php echo get_text($g5['setting']['set_admin_tech_auth']); ?></textarea>
            </td>
        </tr>
        <tr>
		...
		<tr>
			...
			<td colspan="3">
				...
				<p style="margin-top:5px;"><input type="text" name="set_pallet_data_list_page_rows" value="<?php echo $g5['setting']['set_pallet_data_list_page_rows']; ?>" class="frm_input" style="width:50px;"> 빠레트데이터관리 (pallet_data_list.php)</p>
			</td>
		</tr>
		<tr>
