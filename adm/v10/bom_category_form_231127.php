    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <?php if ($w == "") { ?>
                ...
                <input type="text" name="bct_idx" value="<?php echo $subid; ?>" id="bct_idx" required class="required frm_input" size="<?php echo $sublen; ?>" maxlength="<?php echo $sublen; ?>" style="width:90px;">
