...
<h2 id="container_sub_title">
    ...
    <a href="./quality_list.php" class="btn_top_menu '.$active_quality_list.'" style="display:none;">품질관리현황</a>
    <a href="./quality_monthly_excel_form.php" class="btn_top_menu '.$active_quality_monthly_excel_form.'">불량엑셀등록</a>
    '.$sub_title_list.'
</h2>
';
?>
