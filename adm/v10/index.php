...
var items = [
  ...
  {w: 4, h: 2, noResize: true, content: '<div class="widget_title"><span>한달 생산 그래프</span></div><div class="widget_content frame_03"><iframe id="frame_03" src="<?=G5_USER_ADMIN_URL?>/dashboard/production_weekly.php?w=5&h=2" frameborder="0" scrolling="no"></iframe></div>'},
