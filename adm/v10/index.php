...
var items = [
  ...
  {w: 2, h: 1, noResize: true, content: '<div class="widget_title"><span>14호기</span></div><div class="widget_content"><iframe id="frame_02" src="<?=G5_USER_ADMIN_URL?>/dashboard/mms.php?w=2&h=1&mms_idx=368" frameborder="0" scrolling="no"></iframe></div>'},
  {w: 2, h: 1, noResize: true, content: '<div class="widget_title"><span>37호기</span></div><div class="widget_content"><iframe id="frame_02" src="<?=G5_USER_ADMIN_URL?>/dashboard/mms.php?w=2&h=1&mms_idx=132" frameborder="0" scrolling="no"></iframe></div>'},
