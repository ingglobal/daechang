...
.mbt {padding:6px 10px;border:2px solid #70a5cd;background:#a3d8ff;color:#555;border-radius:3px;}
.mbt.focus {border:2px solid skyblue;background:#095d9d;color:#fff;}
</style>
...
function fconfigform_submit(f) {
    ...
    f.action = "./config_quality_manager_form_update.php";
    return true;
}
</script>
