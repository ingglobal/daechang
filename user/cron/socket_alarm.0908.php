...
// 5초 단위 실행 (기본 1분이므로 꽁수를 써야 함)
// * * * * * root wget -O - -q -t 1 http://daechang.epcs.co.kr/user/cron/socket_alarm.php (default = 1 min cycle.)
// * * * * * sleep 5; root wget -O - -q -t 1 http://daechang.epcs.co.kr/user/cron/socket_alarm.php
// * * * * * sleep 10; root wget -O - -q -t 1 http://daechang.epcs.co.kr/user/cron/socket_alarm.php
// * * * * * sleep 15; root wget -O - -q -t 1 http://daechang.epcs.co.kr/user/cron/socket_alarm.php
// * * * * * sleep 20; root wget -O - -q -t 1 http://daechang.epcs.co.kr/user/cron/socket_alarm.php
// * * * * * sleep 25; root wget -O - -q -t 1 http://daechang.epcs.co.kr/user/cron/socket_alarm.php
// * * * * * sleep 30; root wget -O - -q -t 1 http://daechang.epcs.co.kr/user/cron/socket_alarm.php
// * * * * * sleep 35; root wget -O - -q -t 1 http://daechang.epcs.co.kr/user/cron/socket_alarm.php
// * * * * * sleep 40; root wget -O - -q -t 1 http://daechang.epcs.co.kr/user/cron/socket_alarm.php
// * * * * * sleep 45; root wget -O - -q -t 1 http://daechang.epcs.co.kr/user/cron/socket_alarm.php
// * * * * * sleep 50; root wget -O - -q -t 1 http://daechang.epcs.co.kr/user/cron/socket_alarm.php
// * * * * * sleep 55; root wget -O - -q -t 1 http://daechang.epcs.co.kr/user/cron/socket_alarm.php
...
// sudo vi /etc/crontab
// # alarm by every 5 seconds.
// * * * * * root /home/daechang/www/user/cron/socket_alarm.sh
